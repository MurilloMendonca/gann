#include "GANN.hpp"
#include <vector>
#include "Neural-Network/cpp-easy-file-stream/fs.hpp"
...
int main(){
	...
	readDataset("Neural-Network/iris.csv",irisInputs,irisOutputs, 5, 4);
	normalizeInputs(irisInputs);

	std::vector<std::vector<double>> wineInputs, wineOutputs;
	readDataset("Neural-Network/wine.csv",wineInputs,wineOutputs, 14, 0);
	...
	GANN::runWithOutput(nn,wineInputs,wineOutputs);
